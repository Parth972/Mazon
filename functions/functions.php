    ...
    if(!isset($_GET['cat'])){
        if(!isset($_GET['brand'])){
            ...
            while($row_pro=mysqli_fetch_array($run_pro)){
                ...
                echo"
            <div id='single_product' class='card card-hover' style='width: 16rem;float:left;margin:5px;'>
...
?>
<!-- <div class='col-md-3' > 
                    <div id='single_product' class='card card-hover' style='border:none;margin-bottom:10px;'>
                <img src='admin_area/product_images/$pro_image' class='card-img-top' height='180px'>
                <div class='card-body'>
                <h5 class='card-title'>$pro_title</h5>
                <p class='card-text'><b><i>Rs. $pro_price</i></b></p>
                <a href = 'details.php?pro_id=$pro_id' class='card-link'>Details</a>

                <a class='btn btn-primary btn-sm' href = 'index.php?add_cart=$pro_id' style='float:right'>Add to Cart</a>
                </div>
            </div>
            </div> -->